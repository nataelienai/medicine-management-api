...
public class MedicineControllerTest {
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given an empty name")
  void putMedicinesShouldReturn400WhenGivenEmptyName() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a null expiration date")
  void putMedicinesShouldReturn400WhenGivenNullExpirationDate() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        null,
    ...
    assertThatPutMethodReturns400(
        "1.4444.4444.333-1",
        medicineUpdateDto,
        "The expirationDate field must not be null");
  }

  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a null customer service phone")
  void putMedicinesShouldReturn400WhenGivenNullCustomerServicePhone() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
    ...
    assertThatPutMethodReturns400(
        "1.4444.4444.333-1",
        medicineUpdateDto,
        "The customerServicePhone field must not be blank");
  }

  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given an empty customer service phone")
  void putMedicinesShouldReturn400WhenGivenEmptyCustomerServicePhone() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given an invalid customer service phone")
  void putMedicinesShouldReturn400WhenGivenInvalidCustomerServicePhone() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a null price")
  void putMedicinesShouldReturn400WhenGivenNullPrice() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a negative amount of pills")
  void putMedicinesShouldReturn400WhenGivenNegativeAmountOfPills() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a null manufacturer id")
  void putMedicinesShouldReturn400WhenGivenNullManufacturerId() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
  ...
  @Test
  @DisplayName("PUT /medicines/{registrationNumber} should return 400 when given a null set of adverse reactions id")
  void putMedicinesShouldReturn400WhenGivenNullSetOfAdverseReactionIds() throws Exception {
    // given
    MedicineUpdateDto medicineUpdateDto = new MedicineUpdateDto(
        "medicine",
        LocalDate.now(),
